...
public class FlameConfigs {
    ...
    private static void initializeDefaults() {
        ...
        List<BurnoutEffect<?>> torchEffects = Lists.<BurnoutEffect<?>>newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1));
        DEFAULT_LIGHTBRINGERS.put("torch", new LightBringer(Items.TORCH, 64000, 200, 2.0f, 8.0f, torchEffects));
        ...
        DEFAULT_LIGHTBRINGERS.put("lava_bucket", new LightBringer(Items.LAVA_BUCKET, 64000, 40, 2.0f, 100.0f, Lists.newArrayList(new GiveItem(Items.BUCKET, 1), new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(EffectSetup.EASY_TARGET, 2400, 0, false))));
        ...
        DEFAULT_LIGHTBRINGERS.put("light_gray_candle", new LightBringer(Items.LIGHT_GRAY_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(EffectSetup.PIERCER, 80, 0, true))));
        ...
        DEFAULT_LIGHTBRINGERS.put("orange_candle", new LightBringer(Items.ORANGE_CANDLE, 64000, 200, 1.5f, 5.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(EffectSetup.RESILIENCE, 1200, 0, false))));
        ...
        DEFAULT_LIGHTBRINGERS.put("green_candle", new LightBringer(Items.GREEN_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(MobEffects.LUCK, 2400, 0, false), new ApplyPotionEffect(EffectSetup.CASTER, 2400, 2, false))));
        ...
        DEFAULT_LIGHTBRINGERS.put("magenta_candle", new LightBringer(Items.MAGENTA_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new RemovePotionEffect(EffectSetup.BUSTED, false))));
        DEFAULT_LIGHTBRINGERS.put("pink_candle", new LightBringer(Items.PINK_CANDLE, 64000, 200, 1.5f, 4.0f, Lists.newArrayList(new PlaySound(SoundEvents.FIRE_EXTINGUISH, 1, 1), new ApplyPotionEffect(EffectSetup.DEATH_WARD, 40, 0, false))));
    ...
    public static void load() {
        ...
        generateDefaults();
        int count = 0;
        for (File file : Objects.requireNonNull(FLAME_DATA_PATH.toFile().listFiles())) {
            try {
    ...
    public static JsonObject serialize(LightBringer lightBringer) {
        ...
        json.addProperty("item", BuiltInRegistries.ITEM.getKey(lightBringer.item()).toString());
