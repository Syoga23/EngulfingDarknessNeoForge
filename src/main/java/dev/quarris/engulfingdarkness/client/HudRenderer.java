...
public class HudRenderer {
    ...
    public static void renderBurnoutHud(GuiGraphics pGuiGraphics) {
        ...
        player.getCapability(ModRef.Capabilities.DARKNESS).ifPresent(darkness -> {
            ...
            pGuiGraphics.blit(HUD_TEXTURE, barX, barY, 0, 0, 0, barWidth, barHeight, 256, 256); // Burnout backdrop
            ...
            pGuiGraphics.blit(HUD_TEXTURE, barX, barY, 0, 0, 5, (int) renderWidth, barHeight, 256, 256); // Burnout value
            ...
            if (ModRef.configs().debugMode) {
                ...
                pGuiGraphics.blit(HUD_TEXTURE, barX, barY, 0, 0, 0, barWidth, barHeight, 256, 256);
                pGuiGraphics.blit( HUD_TEXTURE, barX, barY, 0, 0, 5, (int) renderWidth, barHeight, 256, 256);
